...
import EosWrap from '@/components/eosWrap'
...
import CustomizeToken from './submit-project'
...
export class Application extends Component {
  ...
  constructor (props) {
    ...
    this.web3CustomizeToken = EosWrap(CustomizeToken)
    this.web3PurchaseHistory = EosWrap(PurchaseHistory)
    this.web3AllTokens = EosWrap(AllTokens)
  }
