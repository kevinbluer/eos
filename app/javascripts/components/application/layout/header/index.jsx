...
import UpriseImage from '@/../images/uprise.png'
        ...
        <div className="container">
          <div className="navbar-brand">
            <div className="navbar-item">
              <NavLink to="/">
                <img className="" src={`/${UpriseImage}`} />
                {/*<span className="icon is-large id-bold">
                    UPRISE&nbsp;<i className="fas fa-people-carry"></i>&nbsp;&nbsp;&nbsp;
                  </span>*/}
              </NavLink>
            </div>
          ...
          <div
            ...
            <div className="navbar-start">
              <div className="navbar-item">
                <NavLink to="/tokens/new" activeClassName="is-active"  className="is-bold">
